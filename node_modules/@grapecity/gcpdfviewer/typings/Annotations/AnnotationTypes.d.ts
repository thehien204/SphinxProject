...
export declare type SignatureInformation = {
    signed: boolean;
    signedByFields: SignatureAnnotation[];
    signatureFields: SignatureAnnotation[];
};
export declare type SignatureValueProps = {
    name: string;
    filter: string;
    subFilter: string;
    location: string;
...
export declare type RotationInit = {
    initRect: number[];
    rotatedRect?: number[];
...
export declare type AnnotationTypeName = ('Text' | 'Link' | 'FreeText' | 'Line' | 'Square' | 'Circle' | 'Polygon' | 'PolyLine' | 'Highlight' | 'Underline' | 'Squiggly' | 'Strikeout' | 'StrikeOut' | 'Stamp' | 'Caret' | 'Ink' | 'Popup' | 'FileAttachment' | 'Sound' | 'Movie' | 'Widget' | 'Screen' | 'PrinterMark' | 'TrapNet' | 'WaterMark' | 'Redact' | 'Signature' | 'ThreadBead' | 'RadioButton' | 'Checkbox' | 'PushButton' | 'Choice' | 'TextWidget' | 'Redact');
